...
const envSchema = z.object({
  ...
  ROUND_BETTING_DURATION: z.coerce.number().min(1000).default(15000),
  ROUND_RESULT_DURATION: z.coerce.number().min(1000).default(10000),
  MIN_BET_AMOUNT: z.coerce.number().min(0.0001).default(1),
  MAX_BET_AMOUNT: z.coerce.number().min(1).default(1000),
  PAYOUT_MULTIPLIER_UP: z.coerce.number().min(1).default(1.95),
  PAYOUT_MULTIPLIER_DOWN: z.coerce.number().min(1).default(1.95),
  PRICE_SNAPSHOT_INTERVAL: z.coerce.number().min(1000).default(5000),
